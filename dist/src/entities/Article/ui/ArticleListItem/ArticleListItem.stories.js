...
var article = {
    ...
    user: {
        id: '1',
        username: 'Ulbi Tv',
        avatar: 'https://img.freepik.com/free-vector/hacker-realistic-composition_98292-38.jpg?1',
    },
    type: [
        'IT',
    ],
        ...
        },
        {
            ...
            paragraphs: [
                ...
                'Существуют и другие способы запуска JS-кода в браузере.'
                    ...
                    + ' рассмотрим пример, демонстрирующий работу с веб-страницей средствами JavaScript, приведённый на '
                    + 'этом ресурсе. Этот пример можно запустить и средствами данного ресурса'
                    + ' (ищите кнопку Try it Yourself), но мы поступим немного иначе. А именно, создадим в каком-нибудь'
                    + ' текстовом редакторе (например — в VS Code или в Notepad++) новый файл, который назовём hello.html,'
                    + ' и добавим в него следующий код:',
            ],
        },
        {
