...
export var NotificationItem = memo(function (props) {
    ...
    var content = (_jsx(Card, __assign({ theme: CardTheme.OUTLINED, className: classNames(cls.NotificationItem, {}, [className]) }, { children: _jsx(Text, { title: item.title, text: item.description }) })));
    if (item.href) {
