...
export var ProfileCard = function (props) {
    ...
    if (isLoading) {
        return (_jsx(HStack, __assign({ justify: "center", max: true, className: classNames(cls.ProfileCard, (_a = {}, _a[cls.loading] = true, _a), [className]) }, { children: _jsx(Loader, {}) })));
    }
    if (error) {
