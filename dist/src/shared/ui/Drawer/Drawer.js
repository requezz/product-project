...
import { useAnimationLibs } from '../../lib/components/AnymationProvider/index';
...
export var DrawerContent = memo(function (props) {
    ...
    return (_jsx(Portal, { children: _jsxs("div", __assign({ className: classNames(cls.Drawer, {}, [className, theme, 'app_drawer']) }, { children: [_jsx(Overlay, { onClick: close }), _jsx(Spring.a.div, __assign({ className: cls.sheet, style: { display: display, bottom: "calc(-100vh + ".concat(height - 100, "px)"), y: y } }, bind(), { children: children }))] })) }));
});
export var Drawer = memo(function (props) {
    ...
    return _jsx(DrawerContent, __assign({}, props));
});
