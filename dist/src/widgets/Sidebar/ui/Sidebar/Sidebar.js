...
export var Sidebar = memo(function (_a) {
    ...
    return (_jsxs("aside", __assign({ "data-testid": "sidebar", className: classNames(cls.Sidebar, (_b = {}, _b[cls.collapsed] = collapsed, _b), [className]) }, { children: [_jsx(Button, __assign({ "data-testid": "sidebar-toggle", type: "button", onClick: onToggle, className: cls.collapseBtn, theme: ButtonType.BACKGROUND_INVERTED, size: ButtonSize.L, square: true }, { children: collapsed ? '>' : '<' })), _jsx(VStack, __assign({ role: "navigation", gap: "8", className: cls.items }, { children: itemsList })), _jsxs("div", __assign({ className: cls.switchers }, { children: [_jsx(ThemeSwitcher, {}), _jsx(LangSwitcher, { short: collapsed, className: cls.lang })] }))] })));
});
