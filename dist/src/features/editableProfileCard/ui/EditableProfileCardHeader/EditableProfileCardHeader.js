...
export var EditableProfileCardHeader = memo(function (props) {
    ...
    return (_jsxs(HStack, __assign({ max: true, justify: "between", className: classNames('', {}, [className]) }, { children: [_jsx(Text, { title: t('Профиль') }), canEdit && (_jsx("div", { children: readonly ? (_jsx(Button, __assign({ theme: ButtonType.OUTLINE, onClick: onEdit, "data-testid": "EditableProfileCardHeader.EditButton" }, { children: t('Редактировать') }))) : (_jsxs(HStack, __assign({ gap: "8" }, { children: [_jsx(Button, __assign({ theme: ButtonType.OUTLINE_RED, onClick: onCancelEdit, "data-testid": "EditableProfileCardHeader.CancelButton" }, { children: t('Отменить') })), _jsx(Button, __assign({ theme: ButtonType.OUTLINE, onClick: onSave, "data-testid": "EditableProfileCardHeader.SaveButton" }, { children: t('Сохранить') }))] }))) }))] })));
});
