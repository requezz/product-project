    ...
    test('При отмене значения должны обнуляться', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, userEvent.clear(screen.getByTestId('ProfileCard.lastname'))];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, userEvent.type(screen.getByTestId('ProfileCard.firstname'), 'user')];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, userEvent.type(screen.getByTestId('ProfileCard.lastname'), 'user')];
                case 5:
                    _a.sent();
                    expect(screen.getByTestId('ProfileCard.firstname')).toHaveValue('user');
                    expect(screen.getByTestId('ProfileCard.lastname')).toHaveValue('user');
                    return [4 /*yield*/, userEvent.click(screen.getByTestId('EditableProfileCardHeader.CancelButton'))];
                case 6:
                    _a.sent();
    ...
    test('Должна появиться ошибка', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, userEvent.click(screen.getByTestId('EditableProfileCardHeader.SaveButton'))];
                case 3:
                    _a.sent();
