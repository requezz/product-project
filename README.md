...
- `npm run create-pub-api` - Скрипт для генерации public api
- `npm run ref-imports` - Скрипт для исправления импортов
...
Также для строгого контроля главных архитектурных принципов используется собственный eslint plugin eslint-plugin-requezz-dev, который содержит 3 правила
